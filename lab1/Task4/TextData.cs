namespace Task4
{
    class TextData
    {
       ...
       private string? ExtractLongestWord()
        ...
        {
            return string.Format("The file, {0}, contains in total {1} vowels and {2} consonants, so in total {3} letters. Moreover, out of {4} available sentences, '{5}' is the longest word", GetFilename(), GetNumberOfVowels(), GetNumberOfConsonants(), GetNumberOfLetters(), GetNumberOfSentences(), GetLongestWord());
        }
    }
}